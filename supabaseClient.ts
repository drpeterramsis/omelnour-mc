 ...
 * 
 * Please run the following SQL in your Supabase SQL Editor to configure the database
 * matching the "Old Website" data structure.
 * 
 * 1. Enable RLS but allow public read
 * 
 ...
 * 
 * -- SEED DATA (Run this once to populate specialties from the old site)
